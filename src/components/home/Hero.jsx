        ...
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
          <div className="flex flex-col sm:flex-row gap-3 items-center">
            <input
              ...
              className="flex-1 w-full px-6 py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-soundbook-light-blue focus:border-transparent"
            />
            <button
              type="submit"
